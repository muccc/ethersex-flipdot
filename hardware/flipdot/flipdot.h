...
#define ROW_GAP 4
#define COLS_PADDING (4 * (MODULE_COUNT%2))

#define DISP_COLS   (MODULE_COUNT*MODULE_COLS)
#define DISP_ROWS   MODULE_ROWS

#define REGISTER_COLS (MODULE_COUNT*MODULE_COLS + ROW_GAP*(MODULE_COUNT))

#define DISP_PIXEL_COUNT (DISP_ROWS*DISP_COLS)
#define DISP_BYTE_COUNT  ((DISP_COLS+COLS_PADDING)*DISP_ROWS/8)
